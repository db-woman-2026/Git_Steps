...
1. [Windows 11 초기 설정](docs/lecture/requirements.md) <span class="print-reference" data-print-reference="true">(Git · Windows 11 x64, Git, GitHub 초기 설정 · 1. Windows Terminal 설치)</span>을 끝냅니다.
2. [Git 기본 읽기 자료](docs/basic/README.md) <span class="print-reference" data-print-reference="true">(Git · Git 기초 개념 · 문서 구성)</span>에서 저장소, stage, commit, branch를 확인합니다.
3. [단계별 실습](docs/lecture/README.md) <span class="print-reference" data-print-reference="true">(Git · Git 단계별 실습 · 실습 원칙)</span>에서 수정할 내용을 확인합니다.
4. 모든 코드는 직접 입력합니다.
