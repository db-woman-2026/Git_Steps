...
Git을 처음 사용한다면 [Windows 11 환경 준비](./windows-11.md) <span class="print-reference" data-print-reference="true">(Git · Windows 11 x64 실습 안내 · 개인 실습 저장소 열기)</span>와 [Git·GitHub·SSH 초기 설정](./lecture/requirements.md) <span class="print-reference" data-print-reference="true">(Git · Windows 11 x64, Git, GitHub 초기 설정 · 1. Windows Terminal 설치)</span>을 먼저 확인합니다.
...
오류가 나면 새 명령을 연속해서 입력하지 않습니다. 현재 branch, `git status`, 직전에 실행한 명령, 변경 파일을 먼저 기록합니다. 해결 절차는 [문제 해결](./troubleshooting.md) <span class="print-reference" data-print-reference="true">(Git · Git 실습 문제 해결 · commit에서 이름과 이메일을 요구합니다)</span>에서 선택합니다.
