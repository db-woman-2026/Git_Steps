...
1. `main`에서 `practice/team-note.md`의 문단을 여러 줄로 수정하고 commit 합니다.
2. 다른 브랜치에서 같은 문단을 다른 방향으로 수정하고 commit 합니다.
3. `main`에서 merge해서 conflict를 만듭니다.
4. 두 변경 내용을 읽고 필요한 문장만 남깁니다.
5. 저장, stage, commit 순서로 마무리합니다.
