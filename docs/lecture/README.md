...
| 장 | 문서 | 결과 |
| --- | --- | --- |
| Step 0 | [저장소 초기화와 최초 push](./step-0.md) | 개인 저장소와 `origin/main` |
| Step 1 | [첫 파일 수정 commit](./step-1.md) | 수정 파일 commit |
| Step 2 | [변경 내용 비교](./step-2.md) | diff 읽기 |
| Step 3 | [첫 branch](./step-3.md) | branch별 파일 차이 |
| Step 4 | [충돌 없는 merge](./step-4.md) | `main`에 변경 합치기 |
| Step 5 | [새 파일 merge](./step-5.md) | 새 파일 추가 |
| Step 6 | [서로 다른 파일 merge](./step-6.md) | 두 branch 합치기 |
| Step 7 | [같은 파일의 다른 위치](./step-7.md) | 자동 merge 확인 |
| Step 8 | [첫 conflict](./step-8.md) | conflict 확인 후 merge 중단 |
| Step 9 | [VS Code로 해결](./step-9.md) | conflict 해결 commit과 코드 실습 준비 |
| Step 10 | [코드 한 줄 conflict](./step-10.md) | formatter 함수 해결 |
| Step 11 | [코드 파일 수정·삭제 conflict](./step-11.md) | 모듈을 살리는 해결 |
| Step 12 | [여러 줄 코드 conflict](./step-12.md) | 실행 흐름 통합 |
