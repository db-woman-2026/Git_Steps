...
> Windows 11에서는 [환경 준비](../windows-11.md) <span class="print-reference" data-print-reference="true">(Git · Windows 11 x64 실습 안내 · 개인 실습 저장소 열기)</span>를 먼저 확인합니다. 아래 명령은 PowerShell에서 실행합니다.
