...
function append(cwd, relativePath, contents) {
...
function commit(cwd, relativePath, message) {
...
try {
  ...
  commit(studentRepository, "practice/goal.md", "Edit goal on main");
  ...
  commit(studentRepository, "practice/goal.md", "Edit goal on branch");
  runGit(studentRepository, "switch", "main");
  assert(
  ...
  commit(studentRepository, "practice/goal.md", "Resolve goal conflict manually");
  ...
  commit(studentRepository, "practice/memo.md", "Edit memo on branch");
  runGit(studentRepository, "switch", "main");
  rmSync(join(studentRepository, "practice/memo.md"));
  commit(studentRepository, "practice/memo.md", "Delete memo on main");
  assert(
  ...
  commit(studentRepository, "practice/team-note.md", "Edit team note on main");
  ...
  commit(studentRepository, "practice/team-note.md", "Edit team note on branch");
  runGit(studentRepository, "switch", "main");
  assert(
  ...
  commit(studentRepository, "practice/team-note.md", "Resolve team note conflict");
  ...
  commit(studentRepository, "practice/diary.md", "Repeat branch practice with diary");
  runGit(studentRepository, "switch", "main");
  ...
  commit(studentRepository, "practice/profile.md", "Repeat branch practice with profile");
  runGit(studentRepository, "switch", "main");
  ...
  console.log("Git lecture smoke test passed: step-0 through step-14");
} finally {
